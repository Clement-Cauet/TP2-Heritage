...
QT_MOC_LITERAL(1, 16, 12), // "pushValueTab"
QT_MOC_LITERAL(2, 29, 0) // ""

    },
    "QLineEdit_Histo\0pushValueTab\0"
};
...
QT_INIT_METAOBJECT const QMetaObject QLineEdit_Histo::staticMetaObject = { {
    QMetaObject::SuperData::link<heritage::staticMetaObject>(),
...
void *QLineEdit_Histo::qt_metacast(const char *_clname)
{
    ...
    return heritage::qt_metacast(_clname);
}

int QLineEdit_Histo::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = heritage::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    if (_c == QMetaObject::InvokeMetaMethod) {
        if (_id < 1)
